-- Update get_receipt_data function to include category and item_type for product/service distinction
-- This allows receipts to properly separate and display products vs services
...
COMMENT ON FUNCTION public.get_receipt_data(UUID) IS 'Public function to retrieve complete receipt data including category and item_type for product/service distinction. Accessible without authentication for receipt viewing.';
