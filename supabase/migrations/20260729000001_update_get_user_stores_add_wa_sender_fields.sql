-- Extend get_user_stores_by_userid to return the new WhatsApp sender fields
-- so the frontend (StoreContext -> StoreWithOwnershipInfo) can read them.
...
COMMENT ON FUNCTION public.get_user_stores_by_userid IS 'Returns stores accessible by a user with enable_qr, enable_points, wa_use_store_number, wa_sender_id, and wa_sender_last_verified fields for store features';
